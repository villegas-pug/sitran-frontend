...
import { limpiarInpuValuesProcNac } from 'redux/actions/formsAction'
import { useSelector, useDispatch } from 'react-redux'
import { initialValues } from 'redux/reducers/formsReducer'
import { guardarProcNac } from 'redux/actions/procNacAction'
...
export default function Test() {
   ...
   /*-> Valores por defecto del reducer...  */
   const { inputValuesProcNac: firstInitValuesInput } = initialValues
