...
export default function AsignarProcedimientoNac() {
   ...
   /*-> HOOK'S...  */
   const [contentInfoModal] = InfoModal({ title: '» DETALLE DEL TRÁMITE ░', width: 1050 })
   const [contentFrmModal] = InfoModal({ type: 'success', title: '» ACTUALIZAR DATOS DEL TRÁMITE ░', width: 1600 })
